...
const dsmr3Update = [
  ...
  '0-1:96.1.0(3232323241424344313233343536373839)\r',
  '0-1:24.1.0(03)\r',
  '0-1:24.3.0(090212376000)(00)(60)(1)(0-1:24.2.1)(m3)\r',
  '(12346.002)\r',
  '0-1:24.4.0(1)\r',
  '!'
]
...
describe('Integration test:', function () {
  ...
  describe('process initial DSMR 3.x telegram: ', function () {
    var telegram
    var updates
    ...
    it('the telegram and updates object should be almost equal', function () {
      delete telegram.gas.equipmentId
      delete telegram.gas.reportedPeriod
      delete telegram.meterModel

      assert.deepEqual(telegram, updates, 'the telegram and updates object are not equal')
    })
  })

  describe('process updates for DSMR 3.: ', function () {
    var actualUpdates = {
      power: {
      ...
      gas: {
        reportedPeriod: 60,
        consumedLastPeriod: 0.992,
        timestamp: 1234530000,
        totalConsumed: 12346.002
      }
    }
    var updates
    ...
    before(function (done) {
      ...
      meter.on('update', (data) => {
        eventUpdate = true
        updates = data
        logger.error(`UPDATE: ${JSON.stringify(data)}`)
      })
